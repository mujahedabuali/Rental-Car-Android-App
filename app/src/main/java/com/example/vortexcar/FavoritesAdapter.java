...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.CarViewHolder> {

    private List<FavCar> carList;
    private List<FavCar> carListFull;
    private Context context;

    public FavoritesAdapter(List<FavCar> carList, Context context) {
    ...
    public void onBindViewHolder(@NonNull CarViewHolder holder, int position) {
        FavCar car = carList.get(position);
