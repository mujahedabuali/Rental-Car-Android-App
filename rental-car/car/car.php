...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $color = $_POST["color"];
    $image = $_POST["image"];
    $sql = "INSERT INTO Car (company, Model_year, SeatsNumber, MonthlyPrice, DailyPrice,price,color,image) VALUES (:company, :Model_year, :SeatsNumber, :MonthlyPrice, :DailyPrice ,:price, :color , :image )";
